...
import {TaskManagerContext} from "@/components/azshoyos/OS/TaskManager";
import {ProgramAction, ProgramConstructor, ProgramType} from "@/components/azshoyos/Program/Program";
...
export const programData:{[key: string]: ProgramConstructor} = {
  ...
  threeWayNineBall: {
    title: "3way9ball",
    description: "A turn tracker for fun game!",
    type: ProgramType.APP_WINDOW,
    appId: 'threeWayNineBall',
    shortcut: {
      icon: "/icons/threeway9ball.svg",
      position: {x: 0, y: 0},
      path: ["games"]
    }
  },
  /* UNCOMMENT TO ADD PEOPLE / PROJECTS TO SITE.
  portfolioPeople: {
    title: "People",
    description: "Portfolio - People",
    type: ProgramType.APP_WINDOW,
    appId: 'portfolioPeople',
    shortcut: {
      icon: "/icons/portfolio_people.svg",
      position: {x: 0.4, y: 0.8},
      path: quickPaths.desktop
    }
  },
  portfolioProjects: {
    title: "Projects",
    ...
    type: ProgramType.APP_WINDOW,
    appId: 'portfolioProjects',
    shortcut: {
      icon: "/icons/portfolio_projects.svg",

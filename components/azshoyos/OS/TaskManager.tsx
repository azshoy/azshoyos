...
import {programData} from "@/components/azshoyos/ProgramData/programs";
import {Shortcut, ShortcutDraggable} from "@/components/azshoyos/Shortcut/Shortcut";
import {v2} from "@/util/types";
import {
  AppWindowProgramClass,
...
} from "@/components/azshoyos/Program/Program";
import {WindowManagerProvider} from "@/components/azshoyos/OS/WindowManager";
import {removeFromArray} from "@/util/misc";
import {useCursor} from "@/components/azshoyos/OS/Cursor";
  ...
  Object.keys(programData).forEach((pID, index) => {
    ...
    switch (pd.type) {
      ...
      case ProgramType.RUNNABLE_SCRIPT:
        ...
        break
      case ProgramType.APP_WINDOW:
        programs[pID] = new AppWindowProgramClass(pd)
        break
    }
